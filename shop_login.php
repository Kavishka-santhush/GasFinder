...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id, shop_name, password FROM shops WHERE email = ?");
...
<head>
    ...
    <title>Shop Login - GasFinder</title>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body p-5">
                        <h2 class="text-center mb-4">Shop Login</h2>
                        ...
                        <div class="text-center mt-3">
                            <p>Don't have an account? <a href="shop_register.php">Register here</a></p>
                        </div>
                    </div>
                </div>
            </div>
